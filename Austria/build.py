...
def scrapeOfficialNumbers():
    ...
    dateregex = re.compile("Stand, (.*) Uhr")
    blabla = soup.find("strong",string=dateregex)
    datematch = dateregex.match(blabla.text)
    datetext = datematch.group(1)
    lastupdate = parseDateTimeWithLocale(datetext, "%d.%m.%Y, %H.%M", "de_DE")
...
austriapop = {
    "Burgenland":293433,
    "Kärnten":560939,
    "Niederösterreich":1677542,
    "Oberösterreich":1482095,
    "Salzburg":555221,
    "Steiermark":1243052,
    "Tirol":754705,
    "Vorarlberg":397094,
...
with open("laender_95_geo.geojson", "r", encoding="utf-8") as source:
